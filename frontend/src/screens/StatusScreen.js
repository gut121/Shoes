...
// });
  ...
  let message=params.vnp_TransactionStatus==='00' ? "Đơn hàng đang được chuẩn bị và Giao tới bạn ✅" : "Giao Dịch Thất Bại ❌"
  let img=params.vnp_TransactionStatus==='00' ? 'thanhcong.gif' : 'thatbai.gif'
  try {
